        ...
        <div class="card-body card-block">
            <form action="{{ route('product.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tipe" value="{{ old('tipe') }}" class="form-control @error('tipe') is-invalid @enderror">
                    @error('tipe')
                        <div class="text-muted">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control ckeditor @error('deskripsi') is-invalid @enderror">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="text-muted">{{ $message }}</div>
                    @enderror
                </div>
